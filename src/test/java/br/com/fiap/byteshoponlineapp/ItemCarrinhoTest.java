...
public class ItemCarrinhoTest {
    ...
    void deveAtualizarQuantidadeDoItem() throws Exception {
        ...
        String itemId = /* extrair id do item do JSON retornado */ "1";
        String atualizaItem = "{\"quantidade\":3}";
        mockMvc.perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.put("/carrinhos/1/itens/" + itemId)
                .contentType("application/json")
                .content(atualizaItem)
        )
            .andExpect(status().isOk())
    ...
    void deveRemoverItemDoCarrinho() throws Exception {
        ...
        String itemId = /* extrair id do item do JSON retornado */ "1";
        mockMvc.perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.delete("/carrinhos/1/itens/" + itemId)
        )
            .andExpect(status().isNoContent());
    }

    @Test
    void deveListarItensDoCarrinho() throws Exception {
        String novoItem = "{\"produtoId\":1,\"quantidade\":2}";
        mockMvc.perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post("/carrinhos/1/itens")
                .contentType("application/json")
        ...
        mockMvc.perform(get("/carrinhos/1/itens"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$[0].produtoId").exists());
    }

    @Test
    void naoDeveAdicionarItemComQuantidadeInvalida() throws Exception {
        String novoItem = "{\"produtoId\":1,\"quantidade\":0}";
        mockMvc.perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post("/carrinhos/1/itens")
                .contentType("application/json")
                .content(novoItem)
    ...
    @Test
    void naoDeveAdicionarItemComProdutoInativo() throws Exception {
        String novoItem = "{\"produtoId\":99,\"quantidade\":1}";
        mockMvc.perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post("/carrinhos/1/itens")
                .contentType("application/json")
                .content(novoItem)
